...
<form method="post" action="result.php">
  <div class="form-group">
    <label>学号</label>
    <?php echo "<input type=\"text\" name=\"Sno\" class=\"form-control\" placeholder=\"13030188013\">"; ?>
  </div>
  <div class="form-group">
    <label>姓名</label>
    <?php echo "<input type=\"text\" name=\"Sname\" class=\"form-control\" placeholder=\"阮思捷\">"; ?>
  </div>
  <div class="form-group">
    <label>年龄</label>
    <?php echo "<input type=\"text\" name=\"Sage\" class=\"form-control\" placeholder=\"21\">"; ?>
  </div>
  <div class="form-group">
    <label>班级</label>
    <?php echo "<input type=\"text\" name=\"Sclass\" class=\"form-control\" placeholder=\"1303018\">"; ?>
  </div>
